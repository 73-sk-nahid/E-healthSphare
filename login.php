...
<body>
    ...
    <div class='container-fluid' >
        <div class='row'>
            <div class='col-md-3'>
                <br> <img src='images/doc-background-two-rights.gif' class='img-responsive' /> <br>
            </div> <!-- this should be a sidebar -->
            <div class='col-md-9'>
                <div class='content-area'>
                    <div class='content-header'>
                    <center>Welcome to E-HealthSphere <br> <small>An online healthcare platform</small> <center> <br>
                    </div>
                            ...
                            <div class='col-md-8'>
                                <div class='row' style='margin-top: 70px;'>
                                    <div class='col-md-4'>
                                        <center>
                                            <div class='img-login-icons'>
                                                <img  class='img-responsive' src='images/3678411 - hospital medical nurse.png' alt='login as a adminr' />
                                            </div>
                                    ...
                                    <div class='col-md-4'>
                                        ...
                                        <center>
                                            <div class='img-login-icons'>
                                                <img  class='img-responsive' src='images/3678443 - ambulance fast fast hospital.png' alt='login as a patient' />
                                            </div>
